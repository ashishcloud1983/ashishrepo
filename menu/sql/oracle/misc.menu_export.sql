-- file created on November 10, 2017, 10:20 am
...
INSERT INTO mnu_task (task_id, task_name, task_desc, button_text, task_type, script_id, is_disabled, pattern_id, subsys_id, initial_passthru, selection_fixed, selection_temp, settings, order_by, keep_data, log_sql_query, screen_refresh, use_https, max_execution_time, task_id_run_at_end, task_id_run_at_cancel, allow_responsive_gui, created_date, created_user, revised_date, revised_user) VALUES ('batch_log(filepicker)', 'Show Batch Log File', NULL, 'Batch Log Files', 'PROC', 'batch_log_filepicker.php', 'N', 'FILEPICKER', 'MISC', NULL, NULL, NULL, 'download=FALSE', NULL, 'N', 'N', '10', 'N', NULL, NULL, NULL, 'N', '2008-11-21 12:09:14', 'AJM', '2009-08-25 16:36:30', 'AJM');
...
INSERT INTO mnu_task (task_id, task_name, task_desc, button_text, task_type, script_id, is_disabled, pattern_id, subsys_id, initial_passthru, selection_fixed, selection_temp, settings, order_by, keep_data, log_sql_query, screen_refresh, use_https, max_execution_time, task_id_run_at_end, task_id_run_at_cancel, allow_responsive_gui, created_date, created_user, revised_date, revised_user) VALUES ('date(all)', 'Select Records with All Dates', NULL, 'All Dates', 'PROC', 'date_all.php', 'N', 'OTHER', 'MISC', NULL, NULL, NULL, NULL, NULL, 'N', 'N', NULL, 'N', NULL, NULL, NULL, 'N', '2017-11-10 10:11:40', 'AJM', NULL, NULL);

INSERT INTO mnu_role_task (role_id, task_id, created_date, created_user, revised_date, revised_user) VALUES ('MENU-RO', 'date(all)', '2017-11-10 10:16:23', 'AJM', NULL, NULL);

INSERT INTO mnu_task (task_id, task_name, task_desc, button_text, task_type, script_id, is_disabled, pattern_id, subsys_id, initial_passthru, selection_fixed, selection_temp, settings, order_by, keep_data, log_sql_query, screen_refresh, use_https, max_execution_time, task_id_run_at_end, task_id_run_at_cancel, allow_responsive_gui, created_date, created_user, revised_date, revised_user) VALUES ('date(current)', 'Select Records with Current Dates', NULL, 'Current', 'PROC', 'date_current.php', 'N', 'OTHER', 'MISC', NULL, NULL, NULL, NULL, NULL, 'N', 'N', NULL, 'N', NULL, NULL, NULL, 'N', '2004-04-17 17:14:09', 'AJM', '2008-02-01 14:30:06', 'AJM');
...
INSERT INTO mnu_task (task_id, task_name, task_desc, button_text, task_type, script_id, is_disabled, pattern_id, subsys_id, initial_passthru, selection_fixed, selection_temp, settings, order_by, keep_data, log_sql_query, screen_refresh, use_https, max_execution_time, task_id_run_at_end, task_id_run_at_cancel, allow_responsive_gui, created_date, created_user, revised_date, revised_user) VALUES ('date(future)', 'Select Records with Future Dates', NULL, 'Future', 'PROC', 'date_future.php', 'N', 'OTHER', 'MISC', NULL, NULL, NULL, NULL, NULL, 'N', 'N', NULL, 'N', NULL, NULL, NULL, 'N', '2004-04-17 17:15:38', 'AJM', '2008-02-01 14:30:15', 'AJM');
...
INSERT INTO mnu_task (task_id, task_name, task_desc, button_text, task_type, script_id, is_disabled, pattern_id, subsys_id, initial_passthru, selection_fixed, selection_temp, settings, order_by, keep_data, log_sql_query, screen_refresh, use_https, max_execution_time, task_id_run_at_end, task_id_run_at_cancel, allow_responsive_gui, created_date, created_user, revised_date, revised_user) VALUES ('date(historic)', 'Select Records with Historic Dates', NULL, 'Historic', 'PROC', 'date_historic.php', 'N', 'OTHER', 'MISC', NULL, NULL, NULL, NULL, NULL, 'N', 'N', NULL, 'N', NULL, NULL, NULL, 'N', '2004-04-17 17:15:01', 'AJM', '2008-02-01 14:30:25', 'AJM');
...
INSERT INTO mnu_task (task_id, task_name, task_desc, button_text, task_type, script_id, is_disabled, pattern_id, subsys_id, initial_passthru, selection_fixed, selection_temp, settings, order_by, keep_data, log_sql_query, screen_refresh, use_https, max_execution_time, task_id_run_at_end, task_id_run_at_cancel, allow_responsive_gui, created_date, created_user, revised_date, revised_user) VALUES ('file(delete)', 'Delete File Name', NULL, 'Delete', 'PROC', 'file(delete).php', 'N', 'DEL2', 'MISC', NULL, NULL, NULL, NULL, NULL, 'N', 'N', NULL, 'N', NULL, NULL, NULL, 'N', '2008-11-24 16:33:57', 'AJM', NULL, NULL);

INSERT INTO mnu_task (task_id, task_name, task_desc, button_text, task_type, script_id, is_disabled, pattern_id, subsys_id, initial_passthru, selection_fixed, selection_temp, settings, order_by, keep_data, log_sql_query, screen_refresh, use_https, max_execution_time, task_id_run_at_end, task_id_run_at_cancel, allow_responsive_gui, created_date, created_user, revised_date, revised_user) VALUES ('file(search)', 'Search File Name', NULL, 'Search', 'PROC', 'file(search).php', 'N', 'SRCH', 'MISC', NULL, NULL, NULL, NULL, NULL, 'N', 'N', NULL, 'N', NULL, NULL, NULL, 'N', '2008-11-22 16:19:22', 'AJM', '2008-11-22 23:06:30', 'AJM');
