...
REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('mnu_motd(list1)', 'date(all)', '009', 'All Dates', 'N', '2017-11-10 11:42:56', 'AJM', NULL, NULL);
...
REPLACE INTO `mnu_role_task` (`role_id`, `task_id`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('MENU-RO', 'mnu_saved_selection(enq1)', '2017-07-26 09:35:38', 'AJM', NULL, NULL);
...
REPLACE INTO `mnu_role_task` (`role_id`, `task_id`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('MENU-RO', 'mnu_saved_selection(list2)', '2017-07-26 09:35:38', 'AJM', NULL, NULL);
...
REPLACE INTO `mnu_role_task` (`role_id`, `task_id`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('MENU-RO', 'mnu_saved_selection(search)', '2017-07-26 09:35:38', 'AJM', NULL, NULL);
...
REPLACE INTO `mnu_role_task` (`role_id`, `task_id`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('MENU-RO', 'mnu_saved_selection(upd1)', '2017-07-26 09:35:48', 'AJM', NULL, NULL);
...
REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('mnu_user_role(list2)', 'audit_dtl(list)3', '013', 'Audit Trail', 'Y', '2014-04-19 09:28:29', 'AJM', '2017-11-10 14:06:49', 'AJM');
REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('mnu_user_role(list2)', 'date(all)', '009', 'All Dates', 'N', '2017-11-10 14:06:18', 'AJM', '2017-11-10 14:06:49', 'AJM');
...
REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('mnu_user_role(list2)', 'mnu_user_role(upd4)movedown', '011', 'Move Down', 'Y', '2017-07-20 15:05:08', 'AJM', '2017-11-10 14:06:49', 'AJM');
REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('mnu_user_role(list2)', 'mnu_user_role(upd4)moveup', '010', 'Move Up', 'Y', '2017-07-20 15:04:54', 'AJM', '2017-11-10 14:06:49', 'AJM');
REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('mnu_user_role(list2)', 'mnu_user_role(upd4)reseq', '012', 'Resequence', 'N', '2017-07-20 15:05:08', 'AJM', '2017-11-10 14:06:49', 'AJM');
...
REPLACE INTO `mnu_motd` (`motd_id`, `motd_subject`, `motd_message`, `start_date`, `end_date`, `role_id`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('3', 'This record expired in Dedcember 2000', NULL, '2000-01-01', '2000-12-31', NULL, '2017-11-10 12:18:18', 'AJM', NULL, NULL);
REPLACE INTO `mnu_motd` (`motd_id`, `motd_subject`, `motd_message`, `start_date`, `end_date`, `role_id`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('4', 'This record won\'t be effective until 2099', NULL, '2099-01-01', '9999-12-31', NULL, '2017-11-10 13:36:20', 'AJM', NULL, NULL);
